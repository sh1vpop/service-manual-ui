...
description: Measure how services perform and turn data into insight that improves services.
...
Their work helps teams continuously improve services and meet the requirements of the [Government Service Standard 10](https://www.gov.uk/service-manual/service-standard).
...
Performance analysts should follow the guidance and standards set out in:
...
- [Data you must publish](https://www.gov.uk/service-manual/measuring-success/data-you-must-publish)
- [Government Digital and Data Profession Capability Framework](https://ddat-capability-framework.service.gov.uk/role/performance-analyst)
...
- [Defra Style Guide](https://digital.defra.gov.uk/content/defra-style-guide)
...
- define performance frameworks and meaningful measures
- establish and monitor service KPIs
- analyse user behaviour and service outcomes
- communicate insight using dashboards and reports
- identify opportunities for continuous service improvement
- support service assessments with performance evidence
- ensure mandatory service performance measures are collected and reported

## Working with your team

Performance analysts work closely with:
...
- understand user and business outcomes
...
- prototype dashboards and reporting
- validate KPIs with the team
...
- monitor service health and trends
...
<div class="defra-callout">
  ...
  <p class="govuk-body">We are expanding the Google Analytics 4 service available to Defra teams.</p>
  <p class="govuk-body">Register your interest and we'll keep you updated as the service develops.</p>
